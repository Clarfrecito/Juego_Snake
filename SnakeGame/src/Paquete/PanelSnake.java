...
public class PanelSnake extends JPanel {
    ...
    public void avanzar() {
        ...
        if (nuevoX < 0 || nuevoX >= cant || nuevoY < 0 || nuevoY >= cant) {
            reproducirSonido("E:\\Juego_Snake_Java-main\\SnakeGameProgramacion\\SnakeGameProgramacion\\src\\Sonidos\\perdiste.wav"); // Ruta del sonido de perder
        ...
        if (existe) {
            ...
            if (nuevo[0] == comida[0] && nuevo[1] == comida[1]) {
                ...
                reproducirSonido("E:\\Juego_Snake_Java-main\\SnakeGameProgramacion\\SnakeGameProgramacion\\src\\Sonidos\\sonido_comida.wav"); // Cambia 'sonido.wav' por el nombre de tu archivo
                if (score > highScore) {
                    highScore = score;
